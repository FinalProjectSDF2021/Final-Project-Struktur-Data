...
public class CharacterMenu extends GameState
{
    Player player;
    private String[] optionsMenu;
    private static final String ASSIGN_SKILL = "Assign Skills";
    private static final String MY_SKILL = "My Skills";
    private static final String INVENTORY = "Inventory";
    private static final String BACK = "Back";
    private int selected;
    private int zoomLevel;

    public CharacterMenu(GameStateManager manager, Player player)
    {
        super(manager);
        this.optionsMenu = new String[] {ASSIGN_SKILL, MY_SKILL, INVENTORY, BACK};
        this.selected = 0;
        this.zoomLevel = 2;
        this.player = player;
    }
            ...
            case KeyEvent.VK_ENTER:
                switch(this.optionsMenu[selected])
                {
                    ...
                    case MY_SKILL:
                        ...
                        break;
                    case INVENTORY:
                        super.gameStateManager.stackState(new InventoryMenu(gameStateManager, player));
                        break;
                    case BACK:
